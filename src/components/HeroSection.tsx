  ...
  return (
    <section className="min-h-screen flex flex-col justify-center px-4 md:px-10 lg:px-20 relative">
      <motion.div
        ...
        className="max-w-4xl"
      >
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-2 text-white">
          [Your Name]
        </h1>
        <h2 className="text-2xl md:text-3xl lg:text-4xl font-medium mb-6 text-neon neon-text">
          [Your Role]
        </h2>
        <div className="h-8">
